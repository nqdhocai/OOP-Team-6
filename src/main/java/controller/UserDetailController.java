...
public class UserDetailController extends DetailController{
    @FXML
    ...
    public void showUserDetail(User clickedUser) throws Exception {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/app/user_detail_view.fxml"));
        DialogPane dialogView = loader.load();
        UserDetailController controller = loader.getController();

        controller.updateUserDetail(clickedUser);
